		...
		<form action="Clientes" method="post">
			<div class="contenedorIN">
				...
				<div>
					...
					<input type="hidden" name="code" value="<%=cedula%>"> <input
						type="text" name="nombre" value="<%=nombre%>"> <input
						type="email" name="email" value="<%=correo%>">
				</div>
				<div>
					<label for="">Direccion</label> <label for="">Telefono</label>
				</div>
				<div>
					<input type="text" name="telefono" value="<%=telefono%>"> <input
